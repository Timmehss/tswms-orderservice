...
### Run Dapr Sidecar
```bash
dapr run --app-id orderservice --app-port 3200 --resources-path ./dapr/components -- dotnet watch run --project ./TSWMS.OrderService.Api/TSWMS.OrderService.Api.csproj
```
